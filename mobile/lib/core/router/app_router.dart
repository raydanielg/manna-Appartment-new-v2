    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/landlord/tenants', builder: (context, state) => TenantsListScreen(propertyId: state.uri.queryParameters['propertyId'])),
          ...
          GoRoute(path: '/landlord/payments', builder: (context, state) => PaymentsListScreen(propertyId: state.uri.queryParameters['propertyId'])),
